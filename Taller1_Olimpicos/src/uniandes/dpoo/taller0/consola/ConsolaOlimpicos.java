...
public class ConsolaOlimpicos
{
	...
	/**
	 * Pide al usuario el nombre de un atleta y retorna el pais asociado a dicho atleta
	 */
	private void ejecutarConsultarPais()
	{
		...
		{
			atleta = atleta.substring(0, 1).toUpperCase()+ atleta.substring(1);
			pais = pais.substring(0, 1).toUpperCase()+ pais.substring(1);
			System.out.println(atleta + " representa el pais " + pais);
		}
